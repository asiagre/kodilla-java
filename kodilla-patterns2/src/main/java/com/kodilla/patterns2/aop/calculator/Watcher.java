...
public class Watcher {
    ...
    public void logStarting() {
        LOGGER.info("Order process has been started");
    }

    @AfterReturning("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))")
    public void logEndingWithoutException() {
        LOGGER.info("Order process has been finished with success");
    }

    @AfterThrowing("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))")
    public void logEndingWithException() {
        LOGGER.info("Order process has been cancelled");
    }
}
