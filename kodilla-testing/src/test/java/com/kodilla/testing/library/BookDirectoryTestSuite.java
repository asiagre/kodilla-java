...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testUserHasNoBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Adam", "Kowalski", "60013112345");
        List<Book> resultListOfBooks = new ArrayList<Book>();
    ...
    @Test
    public void testUserHasOneBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Adam", "Kowalski", "60013112345");
    ...
    @Test
    public void testUserHasFiveBorrowedBooks() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Adam", "Kowalski", "60013112345");
